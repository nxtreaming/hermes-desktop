export default {
  ...
  fireworksHint: "Açık modeller için hızlı çıkarım",
  cerebrasApiKey: "Cerebras API Anahtarı",
  cerebrasHint: "Cerebras donanımında ultra hızlı çıkarım",
  ...
  customHint: "Herhangi bir OpenAI uyumlu uç nokta için yedek anahtar",
